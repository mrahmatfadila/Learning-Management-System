...
const phpPart55RefString1 = require('./data/phpPart55RefString1');
const phpPart56RefString2 = require('./data/phpPart56RefString2');
const phpPart57RefString3 = require('./data/phpPart57RefString3');

async function seedPhpPart55_57() {
  ...
  console.log(`🚀 Memulai pengisian ${allLessons.length} materi String Reference Bab 10 (PHP Reference String 595-631)...`);
  ...
  console.log(`\n🎉 SELURUH STRING REFERENCE SELESAI! Total materi PHP di lms_content_db sekarang: ${resCount.rows[0].count} materi (${chapCount.rows[0].count} Bab).`);

  await pTarget.end();
  await pSource.end();
}

seedPhpPart55_57().catch(console.error);
